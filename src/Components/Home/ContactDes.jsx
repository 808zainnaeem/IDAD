...
<div className="min-h-auto sm:min-h-auto bg-[#0b3d62] flex items-center justify-center px-6 py-16 md:py-24 lg:py-32 overflow-hidden">
  ...
  className="inline-flex items-center justify-center w-14 h-14 md:w-20 md:h-20 border-4 border-[#01a96b] rounded-full ml-4 align-middle relative hidden md:block"
  style={{ top: '-10px' }}
>
  <svg
